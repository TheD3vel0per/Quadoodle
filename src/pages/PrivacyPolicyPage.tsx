        ...
        return (
            <>
                <Container>
                    ...
                    <p>information we collect often depends on the exact nature of our relationship with you and how you choose to use Quadoodle, which is either as a guest or registered user with an account. We have broken these descriptions down into categories to make them clearer:</p>
                    <h3>We collect account information.</h3>
                    <p>We collect information relating to your account. For example, we collect email address and password so you can create a Quadoodle account. You may be able to share other account-related information with us too if you edit your account to include fields like name or payment information to make contribution. So far, NO PAYMENT INFORMATION is collected as this is for future implementation to integrate with a financial API.</p>
                    ...
                    <p>When We Share Information on Quadoodle.</p>
                    ...
                    <p>Sale of information. We only use the personal information we collect to help provide, support, and improve Quadoodle as described in this policy, and we do not “sell” this information to third parties as that term is defined by applicable laws.</p>
                    <h3>Licenses</h3>
                    <p>The context of this site is held through a hackathon project on a free domain. A free SSL certificate is provided by Google Cloud. Please use discretion if/when using Quadoodle.</p>
                    <h3>Children’s Privacy</h3>
                    <p>Quadoodle is intended to be appropriate for general audiences and is not directed to children under the age of 13. We do not intentionally collect personal information from children under 13, and if we learn that we have unintentionally collected any such information, we will promptly take steps to delete it and terminate the child’s account. If you are under the age of 13, please do not use Quadoodle or share your personal information with us.</p>
